  ...
  return (
    <section id="sobre" className="py-24 px-6 bg-white">
      <div className="max-w-4xl mx-auto">
        ...
        {/* PARTE SUPERIOR: Seu Objetivo (Agora ocupando a largura toda) */}
        <div className="mb-16">
        ...
        {/* PARTE INFERIOR: Trajetória Profissional em Abas */}
        <div className="bg-[#F5F1EA] p-8 md:p-10 rounded-3xl shadow-sm border border-[#8C5A3C]/5">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            {/* Menu de Abas (Lado Esquerdo no Desktop) */}
            ...
            {/* Conteúdo da Experiência (Lado Direito no Desktop) */}
            <div className="flex-1 min-h-[250px] bg-white/40 p-8 rounded-2xl border border-white/50 shadow-inner">
              <div className="mb-6">
